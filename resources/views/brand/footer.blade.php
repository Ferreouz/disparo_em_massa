<div>
    <div class="m-4 text-center text-muted">
        ...
        por Gabriel Ferreira</p>
    </div>
    <ul class="nav justify-content-center mb-5">
        <li class="nav-item"><a href="https://www.linkedin.com/in/gabrielferreira-g/" target="_blank" class="nav-link px-2 text-muted">Linkedin</a></li>
        <li class="nav-item"><a href="https://github.com/Ferreouz" target="_blank" class="nav-link px-2 text-muted">GitHub</a></li>
    </ul>
</div>